...
const legalityData = [
  {
    ...
    desc: "Dokumen resmi pendirian perusahaan dari Notaris yang memuat anggaran dasar badan usaha.",
  ...
  },
  {
    ...
    desc: "Legitimasi Badan Hukum PT. Perlindungan hukum penuh untuk operasional dan klien.",
...
const kbliData = [
  ...
  },
  {
    category: "specialist",
    code: "43303",
    title: "Pemasangan Pintu & Jendela",
  },
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm font-bold tracking-widest uppercase text-[#B61F2B]">
                Verified & Secured
              </span>
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight mb-6">
              Legalitas{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#B61F2B] to-red-600">
                Terjamin.
              </span>
              <br />
              Proyek Aman.
            ...
            <p className="text-lg text-slate-500 font-medium leading-relaxed">
              Kami beroperasi di atas fondasi hukum yang kokoh. Transparansi
              dokumen adalah komitmen awal kami sebelum batu pertama diletakkan.
            </p>
          </motion.div>
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              ...
              <h3 className="text-3xl md:text-5xl font-black text-slate-900 mb-6">
                Capability <span className="text-[#B61F2B]">Explorer</span>
              </h3>
              <p className="text-slate-500 text-lg max-w-2xl mx-auto">
                Temukan spesialisasi yang Anda butuhkan. Kami memiliki lisensi
                teknis untuk berbagai sektor konstruksi.
              </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto mb-12 relative group">
              ...
              <div className="relative bg-white border border-slate-200 rounded-2xl flex items-center p-2 shadow-sm">
                ...
                <div className="hidden md:flex gap-2 pr-2">
                  <span className="px-3 py-1 bg-slate-100 rounded-lg text-xs font-bold text-slate-400 border border-slate-200">
                    KB
                  </span>
                  <span className="px-3 py-1 bg-slate-100 rounded-lg text-xs font-bold text-slate-400 border border-slate-200">
                    LI
            ...
            <div className="flex justify-center gap-2 md:gap-4 flex-wrap mb-10">
              ...
              {kbliCategories.map((cat) => (
                ...
                >
                  <span
                    className={
                      activeTab === cat.id ? "text-white" : "text-slate-400"
                    }
                  >
                    {cat.icon}
                  </span>{" "}
              ...
              <AnimatePresence mode="popLayout">
                {filteredKbli.map((item) => (
                  ...
                  >
                    ...
                    <h4 className="text-slate-700 font-bold leading-snug group-hover:text-[#B61F2B] transition-colors">
                      {item.title}
                    </h4>
                  </motion.div>
                ))}
