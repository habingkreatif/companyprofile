...
export default function Home() {
  const services = [
    {
      title: "Perencanaan",
      description: "Perencanaan proyek yang matang dan detail untuk memastikan hasil optimal",
      icon: "📋"
    },
    {
      title: "Konstruksi",
      description: "Jasa konstruksi berkualitas dengan standar tinggi dan profesional",
      icon: "🏗️"
    },
    {
      title: "Management Proyek",
      description: "Pengelolaan proyek yang efisien dan terorganisir dari awal hingga selesai",
      icon: "📊"
    },
    {
      title: "Desain 2D/3D & RAB",
      description: "Desain visualisasi 2D dan 3D lengkap dengan Rencana Anggaran Biaya",
      icon: "🎨"
    },
    {
      title: "Make Over Interior & Eksterior",
      description: "Transformasi ruangan interior dan eksterior dengan desain modern",
      icon: "✨"
    },
    {
      title: "Kitchen Set",
      description: "Desain dan pembuatan kitchen set custom sesuai kebutuhan Anda",
      icon: "🍳"
    },
    {
    ...
    {
      title: "Instalasi MEP",
      description: "Instalasi Mechanical, Electrical, dan Plumbing yang profesional",
      icon: "⚡"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#tentang" className="text-[#3A3A3A] hover:text-[#B61F2B] transition-colors font-medium">
                Tentang
              </a>
              <a href="#layanan" className="text-[#3A3A3A] hover:text-[#B61F2B] transition-colors font-medium">
                Layanan
              </a>
              <a href="#kontak" className="text-[#3A3A3A] hover:text-[#B61F2B] transition-colors font-medium">
                Kontak
              </a>
              <a 
  ...
  <div className="max-w-7xl mx-auto relative z-10 text-center">
    <div className="inline-block mb-6 px-4 py-2 bg-[#B61F2B]/20 border border-[#B61F2B]/30 rounded-full">
      <span className="text-[#F2DCA1] text-sm font-semibold">✨ Garansi 6 Bulan</span>
    </div>
    ...
    <p className="text-lg text-[#C9A74A] mb-10 max-w-2xl mx-auto">
      Dari perencanaan hingga eksekusi, kami hadir memberikan layanan konstruksi berkualitas dengan standar profesional
    </p>
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      {/* About Section */}
      <section id="tentang" className="py-20 px-4 sm:px-6 lg:px-8 bg-white relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-[#101010] mb-4">Tentang Kami</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-[#3A3A3A] leading-relaxed">
                  <strong className="text-[#B61F2B] text-xl">Habs Konstruksi Karya</strong> adalah perusahaan konstruksi profesional yang berkomitmen memberikan layanan terbaik dalam bidang perencanaan, konstruksi, dan management proyek.
                </p>
                <p className="text-lg text-[#3A3A3A] leading-relaxed">
                  Dengan pengalaman dan keahlian yang mumpuni, kami siap membantu mewujudkan impian konstruksi dan renovasi Anda dengan hasil yang berkualitas tinggi.
                </p>
                <div className="bg-gradient-to-r from-[#F2DCA1] to-[#C9A74A] p-6 rounded-xl border-l-4 border-[#B61F2B] shadow-lg">
                  ...
                  <p className="text-[#1E1E1E] mt-2 text-sm">
                    Kami menjamin kualitas pekerjaan dengan memberikan garansi selama 6 bulan
                  </p>
                </div>
              </div>
              <div className="bg-gradient-to-br from-[#162A43] to-[#1E1E1E] p-8 rounded-2xl shadow-2xl">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-[#C9A74A] mb-2">100%</div>
                    <div className="text-[#E2E2E2] text-sm">Kepuasan Klien</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-[#C9A74A] mb-2">6</div>
                    <div className="text-[#E2E2E2] text-sm">Bulan Garansi</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-[#C9A74A] mb-2">8+</div>
                    <div className="text-[#E2E2E2] text-sm">Layanan</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-[#C9A74A] mb-2">24/7</div>
      ...
      {/* Services Section */}
      <section id="layanan" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#F5F5F5] to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-[#101010] mb-4">Layanan Kami</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-[#3A3A3A] text-sm leading-relaxed">{service.description}</p>
      ...
      {/* Contact Section */}
      <section id="kontak" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#162A43] relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0" style={{
            background: 'radial-gradient(circle at 2px 2px, rgba(201, 167, 74, 0.1) 1px, transparent 0)',
            backgroundSize: '40px 40px'
          }}></div>
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/20">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-[#F2DCA1] mb-3">Alamat</h3>
                    <p className="text-white leading-relaxed text-lg">
                      Jl. Parangtritis KM 20 Gedangan<br />
                      Panjangrejo, Pundong<br />
                      Bantul, Yogyakarta
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/20">
                <div className="flex items-start">
                  <div className="text-4xl mr-4">📞</div>
                  <div>
                    <h3 className="text-2xl font-bold text-[#F2DCA1] mb-3">Kontak</h3>
            ...
            <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl shadow-xl border border-white/20 overflow-hidden">
              <h3 className="text-2xl font-bold text-[#F2DCA1] mb-4 px-4">Lokasi Kami</h3>
              <div className="relative w-full h-full min-h-[400px] rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps?q=Jl.+Parangtritis+KM+20+Gedangan,+Panjangrejo,+Pundong,+Bantul&output=embed"
                  width="100%"
                  height="100%"
      ...
      <footer className="bg-[#101010] text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <h4 className="text-lg font-semibold text-[#C9A74A] mb-4">Layanan</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-[#C9A74A] mb-4">Kontak</h4>
              <ul className="space-y-2 text-sm text-[#E2E2E2] ">
                <li>
                  <a href="tel:087792933166" className="hover:text-[#C9A74A] transition-colors flex items-center gap-2">
                    <Phone className="w-4 h-4" /> 0877 9293 3166
                  </a>
                </li>
                <li>
                  <a 
                  ...
                  >
                    <Mail className="w-4 h-4" /> habingkreatif@gmail.com
                  </a>
                </li>
                <li className="">
                  <a 
                ...
                <li>
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="hover:text-[#C9A74A] transition-colors"
                  >
                    💬 Tiktok
                  </a>
                </li>
